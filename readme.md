...
```text
├── SP1_Cryptographic_Benchmarking/  # Performance Benchmarking (AES, RSA, SHA-256)
├── SP2_Privacy_Impact_Assessment/   # PIA (Case Study: COP-MODE)
└── SP3_Dataset_Anonymization/       # Anonymization with ARX (Adult Dataset)
